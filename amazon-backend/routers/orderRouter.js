...
orderRouter.post('/', isAuth ,expressAsyncHandler(async(req,res) => {
        if(req.body.orderItems.length === 0){
            ...
            axios.default.post('http://localhost:3000/api/users/updateGreenCredits',{
                _id:req.user._id,
            ...
            res.status(201).send({message: "New order created.", order: createdOrder,user:updateUser}); //updatedUser fetched by the greenCredits updating api
        }
    })
);
